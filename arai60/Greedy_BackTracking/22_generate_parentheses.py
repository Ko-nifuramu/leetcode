...
class Solution:
    def generateParenthesis(self, n: int) -> List[str]:
        ...
        self.generate_parentheses_helper(
            remain_right, remain_left, "", all_combinations
        )

        return all_combinations

    def generate_parentheses_helper(
        self, remain_right, remain_left, curr_parentheses, all_combinations
    ):
        ...
        if remain_left == 0 and remain_right == 0:
            ...
            self.generate_parentheses_helper(
                remain_right - 1, remain_left, curr_parentheses + ")", all_combinations
            )
            self.generate_parentheses_helper(
                remain_right, remain_left - 1, curr_parentheses + "(", all_combinations
            )
        ...
        def make_combinations(
            ...
            if remain_left_bracket == 0 and remain_right_bracket == 0:
                ...
                all_combinations.append(
                    curr_parentheses + str(")" * remain_right_bracket)
                )
            else:
                make_combinations(
                    remain_right_bracket - 1,
                    remain_left_bracket,
                    curr_parentheses + ")",
                    all_combinations,
                )
                make_combinations(
                    remain_right_bracket,
                    remain_left_bracket - 1,
                    curr_parentheses + "(",
                    all_combinations,
                )

        make_combinations(
            remain_right_bracket, remain_left_bracket, "", all_combinations
        )
...
class Solution:
    def generateParenthesis(self, n: int) -> List[str]:
        ...
        def make_bracket_combinations(
            curr_combination, remain_left_num, remain_right_num
        ):
            ...
            if remain_left_num == remain_right_num:
                make_bracket_combinations(
                    curr_combination + "(", remain_left_num - 1, remain_right_num
                )
                ...
                make_bracket_combinations(
                    curr_combination + ")", remain_left_num, remain_right_num - 1
                )
